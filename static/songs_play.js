const SongsList = [
    ...
    { path: 'static/music.mp3/hello_lyric1.mp3' },
    { path: 'static/music.mp3/hello_lyric2.mp3' },
    { path: 'static/music.mp3/hello_lyric3.mp3' },
    { path: 'static/music.mp3/double_lyric1.mp3' },
    { path: 'static/music.mp3/double_lyric2.mp3' },
    { path: 'static/music.mp3/someone_lyric1.mp3' },
    { path: 'static/music.mp3/someone_lyric2.mp3' },
    { path: 'static/music.mp3/someone_lyric3.mp3' },
    { path: 'static/music.mp3/50_lyric1.mp3' },
    { path: 'static/music.mp3/paris_lyric1.mp3' },
    { path: 'static/music.mp3/paris_lyric2.mp3' },
    { path: 'static/music.mp3/panda_lyric1.mp3' },
    { path: 'static/music.mp3/name_lyric1.mp3' },
    { path: 'static/music.mp3/name_lyric2.mp3' },
    { path: 'static/music.mp3/zombie_lyric1.mp3' },
    { path: 'static/music.mp3/zombie_lyric2.mp3' },
    { path: 'static/music.mp3/darling_lyric1.mp3' },
    { path: 'static/music.mp3/darling_lyric2.mp3' },
    { path: 'static/music.mp3/butter_lyric1.mp3' },
    { path: 'static/music.mp3/butter_lyric2.mp3' },
    { path: 'static/music.mp3/feels_lyric1.mp3' },
    { path: 'static/music.mp3/feels_lyric2.mp3' },
    { path: 'static/music.mp3/feels_lyric3.mp3' },
];
